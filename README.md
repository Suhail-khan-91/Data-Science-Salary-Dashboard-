...
* **[Download Raw Data (All)](data_jobs_salary_all.xlsx)**
* **[Download Raw Data (Monthly)](data_jobs_salary_monthly.xlsx)**
...
=MEDIAN( IF(     (jobs[job_title_short]=A2)*     (jobs[job_country]=country)*   T(ISNUMBER(SEARCH(type,jobs[job_schedule_type])))*     (jobs[salary_year_avg]<>0),     jobs[salary_year_avg] ) )
